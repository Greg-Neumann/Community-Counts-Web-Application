...
namespace CommunityCounts.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //
        // extensions to standard ASP MVC Identity Scaffolding for dedicated actions
        //
        // Administration page
        [Authorize(Roles = "systemAdmin")]
        ...
        public ActionResult RoleManager()
        {
            ...
            var context = new ApplicationDbContext(); // Get Identity database context
        ...
        public ActionResult RoleAddToUser(string UserName, string RoleName)
        {
            ...
            {
                ViewBag.ResultMessage = "User does not exist - check spelling!";
            }
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "systemAdmin")]
        public ActionResult RolesForAUser(string UserName)
        {
        ...
        // Delete role for an existing User
        [HttpPost]
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "systemAdmin")]
        public ActionResult RoleDeleteForAUser(string UserName, string RoleName)
        {
            var context = new ApplicationDbContext();  // Get Identity database context
            ApplicationUser user = context.Users.Where(u => u.UserName.Equals(UserName, StringComparison.CurrentCultureIgnoreCase)).FirstOrDefault();
        ...
        //
        // end of extensions to standard ASP MVC Identity Scaffolding for dedicated actions
        //
